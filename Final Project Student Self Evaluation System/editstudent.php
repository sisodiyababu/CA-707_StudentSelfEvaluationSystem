...
<a href="editstudentpass.php" style="color:red;font-size:16px;margin-left:400px;text-align:center;text-decoration:none;">Change Password</a></div>
...
$query="SELECT * FROM studentinfo WHERE username='$_SESSION[username]'"; // AND password='$_SESSION[password]'";
...
$q1="UPDATE studentinfo set contact='$_POST[contact]' WHERE username='$_SESSION[username]'"; //AND email='$_POST[email]' AND address='$_POST[address]' AND username='$_POST[username]' WHERE username='$_SESSION[username]'";
$q2="UPDATE studentinfo set email='$_POST[email]' WHERE username='$_SESSION[username]'";
$q3="UPDATE studentinfo set address='$_POST[address]' WHERE username='$_SESSION[username]'";
$q4="UPDATE studentinfo set username='$_POST[username]' WHERE username='$_SESSION[username]'";
