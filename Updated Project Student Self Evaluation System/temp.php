...
$query="SELECT * FROM instructorlogininfo WHERE username='$_SESSION[username]'";// AND password=md5('$_SESSION[password]')";
...
<table border='0' cellspacing="10" cellpadding="4" width="60%" align="left" style="background-color:grey;font-size:20px;border:10px solid darkgrey;border-radius:25px;margin-top:5px;margin-left:50px;padding:10px;cellspacing:10px;" >
<tr>
<td >Name</td>
...
<td><?php $_SESSION['field']="username" ?><a href="editinstructor.php"  style="color:red;margin-top:80px;">Edit Account<sup style="color:red">*</sup></a></td>
</div>
<div id="back" style="width:100px;height:50px;align:ceter;margin-top:350px;margin-left:850px;">
