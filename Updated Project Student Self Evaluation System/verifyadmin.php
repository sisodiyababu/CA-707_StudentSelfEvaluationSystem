...
<h4 style="color:red;font-size:18px;text-align:center;">* Only for Administrative head Person</h4></div>
<div id="box" style="width:500px;height:250px;background-color:grey;border:10px solid darkgrey;border-radius:20px;margin-left:420px;padding:10px;cellspacing:10px;">
<h3 style="margin-bottom:0" align="center">Enter your Administrative Username and Password</h3>
<p></p><br>
<form action="<?= $_SERVER['PHP_SELF'] ?>" method="POST" onsubmit="return validatelogin(this);">
<table border="0" width="80%" height="40%" cellspacing="10" cellpadding="10" align="center" >
<tr>
